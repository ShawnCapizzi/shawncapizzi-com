...
export const metadata: Metadata = {
  ...
  description:
    "An early voice-first design exploration for medication adherence, built as an Alexa Skill in 2018 — before voice was a mainstream healthcare category.",
};
...
export default function Page() {
  return (
    <CaseStudyLayout
      ...
      challenge={[
        "In 2017, voice was not yet a category. Amazon Echo was three years old, Alexa Skills were a developer curiosity, and \u201Cconversational design\u201D wasn\u2019t a discipline anyone hired for.",
      ...
      projectShowcases={[
        {
          ...
          description: [
            "Before any prototype, I drew the full VUI architecture on paper. Every user utterance branched into an identified intent, which routed to a set of conditions of response, which routed to device-specific responses, which routed to conversation follow-up.",
          ...
          images: [
            {
              ...
              alt: "Hand-mapped Voice User Interface dialog chart for the Pill Tracker Alexa Skill.",
            },
          ],
        },
        {
          ...
          description: [
            ...
            "The screen and the voice channel had to share state cleanly. Anything you configured by tapping had to be referenceable by asking. That handoff is where most voice products fail.",
          ],
          images: [
            {
              src: `${ASSET_BASE}/03-pill-reminder-setup-mobile.jpg`,
              alt: "Three iPhone screens for the Pill Tracker companion app: pill reminder configuration, alert setup with email and SMS, and an Alert Notice Sent confirmation.",
            },
            {
              src: `${ASSET_BASE}/04-profile-and-alert-settings.jpg`,
              alt: "Three iPhone screens for the Pill Tracker user profile and alert settings.",
            },
          ],
        },
        {
          ...
          description: [
            "The SaySpring prototype let me run early conversational tests with real participants. We worked through utterances, watched where people hesitated, listened for the moments they tried to interrupt the skill mid-sentence.",
            "It is impossible to overstate how much faster you learn voice design by sitting next to someone trying to use voice. Every \u201Cwait, what?\u201D is a redesign brief.",
          ],
          images: [
            {
              src: `${ASSET_BASE}/05-user-research-session.jpg`,
              alt: "A whiteboard research session with four people standing around sticky notes mapping conversational flows during VUI Pill Tracker testing.",
            },
          ],
        },
      ]}
      outcomes={[
        {
          ...
          description:
            "Concept, dialog tree, intents and utterances, prototype, and live user testing — completed before voice design was a discipline anyone was hiring for.",
        },
        {
