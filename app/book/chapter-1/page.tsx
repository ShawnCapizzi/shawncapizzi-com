...
const CHAPTER_ONE: ReaderPage[] = [
  ...
  // ---------- Page 5 · Privacy & true utility ----------
  {
    blocks: [
      ...
      { type: "para", text: "When someone explicitly shares information or preferences, using that feels helpful. But inferring too much from behavioral data \u2014 like knowing someone's 2 AM browsing habits and sending \u201Chaving trouble sleeping?\u201D notifications \u2014 crosses into uncomfortable territory quickly." },
