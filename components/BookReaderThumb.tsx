    ...
    >
      ...
      <div className="relative flex h-full w-full items-center">
        <div className="w-full px-7 md:px-9">
          ...
          <div className="relative min-h-[5em]">
            {quotes.map((q, idx) => (
              <p
                key={idx}
                className={`absolute inset-0 border-l-2 border-[#6b5cff]/55 pl-4 font-serif text-[15px] italic leading-snug text-[#d6dceb] transition-opacity duration-1000 ease-in-out ${
