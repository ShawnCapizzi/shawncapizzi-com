...
const CASE_STUDIES = [
  {
    ...
    image: "/images/case-studies/consumer-care-hub-hero-balanced.gif",
  },
  {
    ...
    image: "/images/case-studies/01-hero-lead-brand-wireframe-to-product.png",
  },
  {
    ...
    image: "/images/case-studies/01-hero-final-person-view-terminal.png",
  },
  {
    ...
    image: "/images/case-studies/01-hero-erase-the-line-campaign-poster.jpeg",
  },
  {
    ...
    image: "/images/case-studies/01-hero-ai-patient-support-disease-first.png",
  },
];
        ...
        <div className="mt-16 md:mt-20 grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10">
          {CASE_STUDIES.map((cs) => (
            <Link
              key={cs.slug}
              href={`/work/${cs.slug}`}
              className="group relative block rounded-2xl bg-bg-elevated border border-border-subtle hover:border-border-default overflow-hidden transition-colors"
            >
